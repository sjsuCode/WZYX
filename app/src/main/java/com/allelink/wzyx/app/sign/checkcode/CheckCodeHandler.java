...
import com.allelink.wzyx.model.SignResponse;
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                if(!TextUtils.isEmpty(responseString) && response.isSuccessful()){
                    ...
                    signResponse = JSON.parseObject(responseString, SignResponse.class);
                    if(SUCCESS.equals(signResponse.getResult())){
                        //成功的回调
                        checkCodeSendListener.onCheckCodeSendSuccess(signResponse.getMessage());
                    }else if(ERROR.equals(signResponse.getResult())){
                        //失败的回调
                        checkCodeSendListener.onCheckCodeSendFailure(signResponse.getMessage());
                    }
                }else{
                    try {
